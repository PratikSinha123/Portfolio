        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">GitHub Pages</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Bridging the gap between human-centric design and artificial intelligence. I actively develop AI models, such as trachea prediction systems for UPES research, and leverage advanced AI workflows to build intelligent applications.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Resume Optimization</div>
                <div className="what-tags">Layout Structuring</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
